...
public class ServiceCreateTemplateParam {
    ...
    public ServiceCreateTemplateParam() {
    }

    public ServiceCreateTemplateParam(
            String name, String description, Long userId, String username, Long projectId, Long pipelineId,
