...
public class AllInOneOnPremiseBoot {
    private static final Logger logger = LoggerFactory.getLogger(AllInOneOnPremiseBoot.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        // start modules (no pay,sms,email,ip)
