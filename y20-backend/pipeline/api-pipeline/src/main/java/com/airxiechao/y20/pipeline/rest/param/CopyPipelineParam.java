...
public class CopyPipelineParam {
    ...
    public String getToPipelineName() {
        return toPipelineName;
    }

    public void setToPipelineName(String toPipelineName) {
        this.toPipelineName = toPipelineName;
    }
}
