...
public class StopUploadFileExplorerRunInstanceParam {
    ...
    public StopUploadFileExplorerRunInstanceParam() {
    }

    public StopUploadFileExplorerRunInstanceParam(String pipelineRunInstanceUuid, String explorerRunInstanceUuid, String path) {
