...
public class RemoveFileHolderExplorerRunInstanceParam {
    ...
    public RemoveFileHolderExplorerRunInstanceParam() {
    }

    public RemoveFileHolderExplorerRunInstanceParam(String pipelineRunInstanceUuid, String explorerRunInstanceUuid, String holderId) {
