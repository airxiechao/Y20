...
public class LinuxScriptNotInDockerEnvStepRunParam {
    @StepTypeParam(
            displayName = "脚本",
    ...
    public LinuxScriptNotInDockerEnvStepRunParam(String script, String executor, String workingDir, String outputs) {
        this.script = script;
