...
public class ListFileExplorerRunInstanceParam {
    ...
    public ListFileExplorerRunInstanceParam() {
    }

    public ListFileExplorerRunInstanceParam(String pipelineRunInstanceUuid, String explorerRunInstanceUuid, String path) {
