...
public class EnhancedRpcUtil {
    ...
    public static AccessPrincipal extractAccessPrincipal(RpcExchange exchange) throws Exception {
    ...
    public static <T> T getObjectParamWithAuth(RpcExchange exchange, Class<T> tClass) throws Exception {
        // get user id
